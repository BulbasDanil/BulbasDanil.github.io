...
(function () {
  cssFileName = "chatbot_wrapper_commencement_default.css";
  ...
  function loadCSS() {
    ...
    if (currentScriptSrc) {
      ...
      cssLinkChatbot.href = cdnPath + cssFileName; // ! UPDATE for each version !
  ...
  function initChatBot() {
    ...
    chatIcon.innerHTML =
      'Ask Rocky &nbsp; <img class="atheleticsicon" alt="Rocky with a mortorboard" aria-hidden="true" src="cdn/chatbot_canvas/media/ChatIcon-commencement.png" />';
